...
import random
import re
from kerykeion import AstrologicalSubject  # Install with pip install kerykeion
...
def fetch_kerykeion_data(date):
    """Calculate transit data using Kerykeion"""
    try:
        # Use 04:30 PM IST (16:30 UTC) as the base time for the day
        transit = AstrologicalSubject(
            "Transit", date.year, date.month, date.day, 16, 30,  # 04:30 PM UTC
